...
namespace Xadrez_Console.xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroExecption("A peça de origem escolhida não é a sua!");
            }
        ...
        public void validarPosicaoDeDestino(Posicao origem, Posicao destino)
        {
            ...
            {
                throw new TabuleiroExecption("Posição de destino invalida! ");
            }
        }
        ...
        public bool estaEmXeque(Cor cor)
        {
            ...
            if (R == null)
            {
                throw new TabuleiroExecption("ERRO: Não tem rei da cor" + cor + "no tabuleiro!");
            }
